    ...
    <div className="min-h-screen bg-white font-mono p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center border-2 border-black p-4 mb-6">
          ...
          <p className="text-sm">Admin Order Entry</p>
          <div className="text-xl"> </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {filteredMenuItems.map(item => (
                      ...
                      >
                        ...
                        <p className="text-sm font-bold">B{item.price.toFixed(2)}</p>
                      </button>
                    ))}
                  </div>
                ) : (
                    ...
                    <div key={index} className="p-3">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <div className="text-right">
                          <p className="text-xs text-gray-600">B{item.price.toFixed(2)}  {item.quantity}</p>
                          <p className="font-bold">B{item.subtotal.toFixed(2)}</p>
                        </div>
                      </div>
                    </div>
                  ))
